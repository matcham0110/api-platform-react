 ...
 *          "description"="Incrémente unitairement une facture"    
 *      }
 *   }
 * },
 * attributes={
...
class Invoice
{
     ...
     * @Assert\Type(type="numeric", message="numérique")
     */
    private $amout;
     ...
     * @Assert\NotBlank(message="date pas vide")
     */
    private $sentAt;
    ...
    /**
     * Permet de récupérer le User par facture
     * @Groups({"invoices_read", "invoices_subresource"})
     * 
     * @return User
     */
